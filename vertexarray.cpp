...
{
    m_layout.push_back({varLocation, elementCount,GL_FLOAT,GL_FALSE});
...
{
    m_layout.push_back({varLocation, elementCount,GL_FLOAT,normalized});
     m_stride += elementCount*sizeof(GLfloat);
}
...
{
    m_layout.push_back({varLocation, elementCount, GL_UNSIGNED_INT, GL_FALSE});
...
{
    m_layout.push_back({varLocation, elementCount,GL_UNSIGNED_INT,normalized});
    m_stride += elementCount*sizeof(GLuint);
}
...
{
    m_layout.push_back({varLocation, elementCount, GL_BYTE, GL_TRUE});
...
{
    m_layout.push_back({varLocation, elementCount,GL_BYTE, normalized});
    m_stride += elementCount*sizeof(GLbyte);
}
